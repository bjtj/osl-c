...
extern "C" {
    ...
    extern OSL_EXPORT osl_queue_t * osl_queue_init(osl_queue_t *, osl_free_cb);
    extern OSL_EXPORT osl_bool osl_queue_is_empty(osl_queue_t *);
    extern OSL_EXPORT void osl_queue_clear(osl_queue_t *);
    extern OSL_EXPORT void osl_queue_push(osl_queue_t *, void *);
    extern OSL_EXPORT void * osl_queue_pop(osl_queue_t *);
    extern OSL_EXPORT void osl_queue_free(osl_queue_t *);
